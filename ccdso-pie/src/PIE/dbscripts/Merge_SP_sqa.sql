USE [CC_PIE]
GO
/****** Object:  StoredProcedure [App].[sqa_merge_Caresite]    Script Date: 7/2/2019 4:34:24 PM ******/
DROP PROCEDURE [App].[sqa_merge_Caresite]
GO
--
DROP PROCEDURE [App].[sqa_merge_NonVAProvider]
GO
--
DROP PROCEDURE [App].[sqa_merge_ProviderAgreement]
GO
--
DROP PROCEDURE [App].[sqa_merge_ProviderService]
GO
--
--
SET ANSI_NULLS ON
...
GO
CREATE PROCEDURE [App].[sqa_merge_Caresite]
AS
DECLARE @T TABLE([CareSite_stg_Id] INT);

MERGE [App].[sqa_CareSite_V] AS T
USING [App].[sqa_CareSite_stg_V] AS S
...
DELETE From [App].[sqa_CareSite_stg_V] WHERE CareSite_stg_Id in (SELECT CareSite_stg_Id FROM @T);
GO
--
--
--
CREATE PROCEDURE [App].[sqa_merge_NonVAProvider]
AS

DECLARE @T TABLE([NonVAProvider_stg_Id] INT);

MERGE [App].[sqa_NonVAProvider_V] AS T
USING [App].[sqa_NonVAProvider_stg_V] AS S
...
DELETE [App].[sqa_NonVAProvider_stg_V] WHERE NonVAProvider_stg_Id in (SELECT NonVAProvider_stg_Id FROM @T);
GO
--
--
CREATE PROCEDURE [App].[sqa_merge_ProviderAgreement]
AS

DECLARE @T TABLE([ProviderAgreement_stg_Id] INT);

MERGE [App].[sqa_ProviderAgreement_V] AS T
USING [App].[sqa_ProviderAgreement_stg_V] AS S
...
DELETE [App].[sqa_ProviderAgreement_stg_V] WHERE ProviderAgreement_stg_Id in (SELECT ProviderAgreement_stg_Id FROM @T);
GO
--
--
CREATE PROCEDURE [App].[sqa_merge_ProviderService]
AS

DECLARE @T TABLE([ProviderServiceCareSite_stg_Id] INT);

MERGE [App].[sqa_ProviderServiceCareSite_V] AS T
USING [App].[sqa_ProviderServiceCareSite_stg_V] AS S
...
DELETE [App].[sqa_ProviderServiceCareSite_stg_V] WHERE ProviderServiceCareSite_stg_Id in (SELECT ProviderServiceCareSite_stg_Id FROM @T);
GO
