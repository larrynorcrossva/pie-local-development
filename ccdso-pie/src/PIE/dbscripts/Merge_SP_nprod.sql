USE [CC_PIE]
GO
/****** Object:  StoredProcedure [App].[nprod_merge_Caresite]    Script Date: 7/2/2019 4:34:24 PM ******/
DROP PROCEDURE [App].[nprod_merge_Caresite]
GO
--
DROP PROCEDURE [App].[nprod_merge_NonVAProvider]
GO
--
DROP PROCEDURE [App].[nprod_merge_ProviderAgreement]
GO
--
DROP PROCEDURE [App].[nprod_merge_ProviderService]
GO
--
--
SET ANSI_NULLS ON
...
GO
CREATE PROCEDURE [App].[nprod_merge_Caresite]
AS
DECLARE @T TABLE([CareSite_stg_Id] INT);

MERGE [App].[nprod_CareSite_V] AS T
USING [App].[nprod_CareSite_stg_V] AS S
...
DELETE From [App].[nprod_CareSite_stg_V] WHERE CareSite_stg_Id in (SELECT CareSite_stg_Id FROM @T);
GO
--
--
--
CREATE PROCEDURE [App].[nprod_merge_NonVAProvider]
AS

DECLARE @T TABLE([NonVAProvider_stg_Id] INT);

MERGE [App].[nprod_NonVAProvider_V] AS T
USING [App].[nprod_NonVAProvider_stg_V] AS S
...
DELETE [App].[nprod_NonVAProvider_stg_V] WHERE NonVAProvider_stg_Id in (SELECT NonVAProvider_stg_Id FROM @T);
GO
--
--
CREATE PROCEDURE [App].[nprod_merge_ProviderAgreement]
AS

DECLARE @T TABLE([ProviderAgreement_stg_Id] INT);

MERGE [App].[nprod_ProviderAgreement_V] AS T
USING [App].[nprod_ProviderAgreement_stg_V] AS S
...
DELETE [App].[nprod_ProviderAgreement_stg_V] WHERE ProviderAgreement_stg_Id in (SELECT ProviderAgreement_stg_Id FROM @T);
GO
--
--
CREATE PROCEDURE [App].[nprod_merge_ProviderService]
AS

DECLARE @T TABLE([ProviderServiceCareSite_stg_Id] INT);

MERGE [App].[nprod_ProviderServiceCareSite_V] AS T
USING [App].[nprod_ProviderServiceCareSite_stg_V] AS S
...
DELETE [App].[nprod_ProviderServiceCareSite_stg_V] WHERE ProviderServiceCareSite_stg_Id in (SELECT ProviderServiceCareSite_stg_Id FROM @T);
GO
