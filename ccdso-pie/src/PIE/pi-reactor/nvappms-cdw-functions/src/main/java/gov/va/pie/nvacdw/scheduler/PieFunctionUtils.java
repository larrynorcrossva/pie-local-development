...
public class PieFunctionUtils {
	...
	public static final String SERVER_URL = "https://nvacdw.ppms.va.gov";

	public static final String PPMS_ENDPOINT_URL = SERVER_URL + "/pie/ppms/triggers/nvacdw";
	
	public static final String CERNER_ENDPOINT_URL = SERVER_URL + "/pie/ppms/triggers/integration";
