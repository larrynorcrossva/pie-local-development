package gov.va.pie.nvappms.cdw.exception;
...
public class CDWResponseErrorHandler implements ResponseErrorHandler {
	
	static final Logger log = LogManager.getLogger(CDWResponseErrorHandler.class);
