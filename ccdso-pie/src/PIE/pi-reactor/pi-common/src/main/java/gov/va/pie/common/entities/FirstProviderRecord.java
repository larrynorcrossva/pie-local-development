...
/**
 * The entity class for the FirstProviderRecord_V database view.
 * 
 */
@Entity
@Table(name=CommonConstants.DB_ENV+"FirstProviderRecord_V")

public class FirstProviderRecord implements Serializable {
